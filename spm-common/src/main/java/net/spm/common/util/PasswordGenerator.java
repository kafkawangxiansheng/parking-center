...
public class PasswordGenerator {
	...
	public static String createPasswordRamdom() {
		return generateRandomString(6, 6, 2, 1, 1, 0);
	}
	...
	public static boolean verifyPassword(String password, String passwordInDB) {
		PasswordEncoder passwordEnocder = new BCryptPasswordEncoder();
		if (passwordEnocder.matches(password, passwordInDB)) {
			return Boolean.TRUE;
		}
	...
	public static void main(String[] args) throws ParseException {
		String password = generateRandomString(6, 6, 2, 1, 1, 0);
		System.out.println(password);

		String passwordInDb = encryptPassword(password);
		System.out.println(passwordInDb);

		System.out.println(verifyPassword(password, passwordInDb));
